...
RUN wget http://issuecdn.baidupcs.com/issue/netdisk/LinuxGuanjia/baidunetdisk_linux_2.0.1.deb -O baidunetdisk.deb && apt install -y ./baidunetdisk.deb && rm -rf /var/lib/apt/lists/* && rm -rf /var/cache/apk/* && apt-get autoremove && rm -rf baidunetdisk.deb
